...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    &nbsp;<asp:TextBox ID="Tittelfelt" runat="server" Width="519px" CssClass="x-redigertittel-textarea"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Tittelfelt"
    ...
    <asp:TextBox ID="Innleggstekst" runat="server" Height="185px" TextMode="MultiLine" Width="737px" CssClass="x-redigerinnlegg-textarea"></asp:TextBox><br />
    
    <table id="Table1" runat="server" class="x-innleggstabell" >
        <tbody>
        </tbody>
    </table>
    <asp:Button ID="sendInnlegg" runat="server" OnClick="Button1_Click" Text="Send" />
    <asp:RequiredFieldValidator ID="Innleggstekstvalidator" runat="server" ControlToValidate="Innleggstekst"
        ErrorMessage="Innlegget må inneholde tekst"></asp:RequiredFieldValidator>
