...
<asp:Table ID="Listetabell" runat="server" Width="582px">
    ...
    <asp:TableRow runat="server">
        ...
        <asp:TableCell runat="server">
            <asp:TextBox ID="Pris" runat="server" ValidationGroup="ObligFelt" CausesValidation="true"></asp:TextBox>
    ...
    <asp:TableRow runat="server">
        <asp:TableCell runat="server">Antall på lager:</asp:TableCell>
        <asp:TableCell runat="server">
            <asp:TextBox ID="Lagerstatus" runat="server" ValidationGroup="ObligFelt" CausesValidation="true"></asp:TextBox>
